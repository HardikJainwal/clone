...
const Partners = () => {
  ...
  const partners = [
    ...
    },
    {
      ...
      name: 'Apollo',
      link: 'https://www.apollohospitals.com/delhi/',
    },
  ];
              ...
              <div key={partner.id} className="px-2 pb-4">
                ...
                >
                  <img
                    ...
                    className="max-w-[90%] max-h-[90%] object-contain filter hover:brightness-125 transition-all duration-300" // Larger image
                  />
                </div>
              </div>
            ))}
